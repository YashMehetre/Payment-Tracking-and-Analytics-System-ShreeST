...
function loadSum() {
  ...
  document.getElementById("totalBoxes").innerText = sumBoxes.toLocaleString(
    "en-IN",
    { useGrouping: true }
  );
  document.getElementById("totalPaymentAmount").innerText =
    sumPayment.toLocaleString("en-IN", { useGrouping: true });
  document.getElementById("totalPendingAmount").innerText =
    sumPending.toLocaleString("en-IN", { useGrouping: true });
  document.getElementById(
    "finalPendingAmt"
  ).innerHTML = `Pending Amount = <span>&#8377;</span>${(
    sumPending - sumPayment
